...
export const lockdownDownloads = Object.freeze({
  ...
  // Simple Ujian Browser .exe disajikan langsung dari Firebase Hosting (public/),
  // sama seperti file .seb — unduh langsung tanpa halaman "Virus scan warning"
  // yang muncul bila file >25MB di-host di Google Drive.
  subWindowsExe: "/SimpleUjianBrowser.exe",
